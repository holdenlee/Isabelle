...
The proofs are standard; the proofs of the replacement theorem and rank-nullity theorem roughly follow the presentation in~\cite{FIS}. The rank-nullity theorem generalises the existing development in~\cite{AD13} (originally using type classes, now using a mix of type classes and locales).
}
